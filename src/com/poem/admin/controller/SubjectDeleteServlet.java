...
public class SubjectDeleteServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String deleteSubject = request.getParameter("DeleteSubject");
		System.out.println(deleteSubject);
		
		SubjectDAO subjectDao = SubjectDAO.getInstance();
		
		int result = subjectDao.deleteSubject(deleteSubject);
		if(result == 1) {
			System.out.println("주제 삭제");
