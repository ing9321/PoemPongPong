...
<%
	...
	String sql = "select W.WeeklyPoem_Index, W.Subject_Name, W.Title, W.Contents, W.ViewCount, W.LikeCount, W.UploadDate, W.BestPoem, ";
			sql += "M.Member_ID, M.Member_Poet, M.Member_Photo from WEEKLYPOEM W natural join MEMBER M order by W.WeeklyPoem_Index desc";
	...
	while(rs.next()){
		...
		obj.put("BESTPOEM", rs.getInt(8));
		obj.put("ID", rs.getString(9));
		obj.put("POET", rs.getString(10));
		obj.put("PROFILE", rs.getString(11));
